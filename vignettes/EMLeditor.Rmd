...
```
# Dependencies
In addition to [EMLeditor](https://github.com/nationalparkservice/EMLeditor), you will also need the [EML package](https://cran.r-project.org/web/packages/EML/index.html) to complete these steps. 

...
### Software
R and probably Rstudio installed on your computer. These are both available in Software Center. See the [R Advisory Group's website](https://doimspp.sharepoint.com/sites/nps-nrss-imdiv/SitePages/R-Adv.aspx) for more information. You will also need to install the R package [tidyverse](https://www.tidyverse.org/) as well as some other packages from CRAN. Many of these are available as part of the [NPSdataverse](https://doi-nps.github.io/NPSdataverse/) package. 
